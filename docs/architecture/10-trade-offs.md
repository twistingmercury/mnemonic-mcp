...
| Internal Protocol | gRPC + MCP (Cognee)              | Simplicity, debugging ease  | [ADR-002](02-architectural-decisions.md#adr-002) |
| Cognee Deployment | Separate service (separate pods) | Same pod simplicity         | [ADR-003](02-architectural-decisions.md#adr-003) |
