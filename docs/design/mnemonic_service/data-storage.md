...
```sql
-- migrations/postgres/001_extensions_and_functions.up.sql
...
```sql
-- migrations/postgres/001_extensions_and_functions.down.sql
...
```sql
-- migrations/postgres/002_create_agents.up.sql
...
```sql
-- migrations/postgres/002_create_agents.down.sql
...
```sql
-- migrations/postgres/003_create_patterns.up.sql
...
```sql
-- migrations/postgres/003_create_patterns.down.sql
...
```sql
-- migrations/postgres/004_create_pattern_agent_associations.up.sql
...
```sql
-- migrations/postgres/004_create_pattern_agent_associations.down.sql
...
```sql
-- migrations/postgres/005_create_routing_rules.up.sql
...
```sql
-- migrations/postgres/005_create_routing_rules.down.sql
...
```sql
-- migrations/postgres/006_create_enrichment_jobs.up.sql
...
```sql
-- migrations/postgres/006_create_enrichment_jobs.down.sql
...
```sql
-- migrations/postgres/007_create_performance_indexes.up.sql
...
```sql
-- migrations/postgres/007_create_performance_indexes.down.sql
...
WARN  create missing constraints using: migrations/neo4j/001_create_constraints.cypher
```
...
```bash
# Using cypher-shell
cypher-shell -u neo4j -p <password> -f migrations/neo4j/001_create_constraints.cypher
```

### Index Configuration

```cypher
// migrations/neo4j/002_create_indexes.cypher
