...
1. Configure Cognee MCP server following instructions in [../memory-mcp/README.md](../memory-mcp/README.md). This is a necessary first step, otherwise the agents will not function!
